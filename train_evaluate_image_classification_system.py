...
transform_train = transforms.Compose([ # DATA AUGMENTATION STRATEGIES
...
if args.block_type == 'conv_block':
    ...
    processing_block_type = ConvolutionalProcessingBlockBatchNormalized
    dim_reduction_block_type = ConvolutionalDimensionalityReductionBlockBatchNormalized
elif args.block_type == 'BN_RC':
    processing_block_type = ConvolutionalProcessingBlockBatchNormalizedResConn
    dim_reduction_block_type = ConvolutionalDimensionalityReductionBlockBatchNormalized
